                    ...
                    <div class="form-group">
                        ...
                        <select id="prefecture" name="prefecture" class="form-control">
                            ...
                            @foreach($prefectures as $id => $name)
                                <option value="{{ $id }}" {{ request('prefecture') == $id ? 'selected' : '' }}>{{ $name }}</option>
                            @endforeach
                        </select>
                    </div>
                        ...
                        <div class="time-range-group">
                            <select id="time_start" name="time_start" class="form-control">
                                ...
                                @for($h = 0; $h < 24; $h++)
                                    @foreach(['00', '15', '30', '45'] as $m)
                                        ...
                                        <option value="{{ $time }}" {{ request('time_start') === $time ? 'selected' : '' }}>{{ $time }}</option>
                                    @endforeach
                                @endfor
                            </select>
                            ...
                            <select id="time_end" name="time_end" class="form-control">
                                ...
                                @for($h = 0; $h < 24; $h++)
                                    @foreach(['00', '15', '30', '45'] as $m)
                                        @php $time = sprintf('%02d:%s', $h, $m); @endphp
                                        <option value="{{ $time }}" {{ request('time_end') === $time ? 'selected' : '' }}>{{ $time }}</option>
                                    @endforeach
                                @endfor
                            </select>
                        </div>
