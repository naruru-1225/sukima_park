                ...
                <form action="{{ url('/admin/users/' . $user->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex; align-items: center; gap: 16px;">
                            <div style="width: 80px; height: 80px; border-radius: 50%; background: #e0e0e0; display: flex; align-items: center; justify-content: center; font-size: 32px; overflow: hidden;">
                                @if($user->avatar ?? null)
                                    <img src="{{ asset('storage/' . $user->avatar) }}" alt="アイコン" style="width: 100%; height: 100%; object-fit: cover;">
                                @else
                                    👤
                                @endif
                            </div>
