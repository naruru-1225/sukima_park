...
4. [Docker（ドッカー）とは](#dockerドッカーとは)
5. [毎日の作業の流れ](#毎日の作業の流れ)
6. [必要なソフトのインストール](#必要なソフトのインストール)
7. [セットアップ手順](#セットアップ手順)
8. [Laravelのフォルダ構成](#laravelのフォルダ構成)
9. [PHP基礎文法](#php基礎文法)
10. [Laravelの書き方](#laravelの書き方)
11. [phpMyAdminの使い方](#phpmyadminの使い方)
12. [モデルの使い方](#モデルの使い方)
13. [よく使うコマンド](#よく使うコマンド)
14. [トラブルシューティング](#トラブルシューティング)
15. [初心者がよくやる間違いTOP10](#-初心者がよくやる間違いtop10)
16. [理解度チェッククイズ](#-理解度チェッククイズ)
17. [さらに学ぶために](#-さらに学ぶために)
...
| 用語 | 意味 |
|-----|------|
| **イメージ** | 環境の「設計図」。PHPやMySQLの設定が書かれている |
| **コンテナ** | イメージから作られた「実行中の環境」 |
| **docker-compose.yml** | 複数のコンテナをまとめて管理する設定ファイル |
| **ボリューム** | データを永続化する仕組み（コンテナを消してもデータは残る） |
